...
```bash
wget -O koha-systemd.deb https://github.com/thekesolutions/koha-systemd/releases/latest/download/koha-systemd_1.0.2_all.deb
...
```bash
wget --content-disposition https://github.com/thekesolutions/koha-systemd/releases/latest/download/koha-systemd_1.0.2_all.deb
